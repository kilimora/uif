...
.hstat{padding:clamp(8px,1.3vh,16px) 20px 0;border-right:1px solid rgba(255,255,255,.1)}
.hstat:last-child{border-right:0}
.hstat b{display:block;font-family:'JetBrains Mono',monospace;font-size:clamp(15px,2vh,23px);color:var(--lime-soft);font-weight:700;line-height:1}
.hstat span{font-size:clamp(8px,1vh,10.5px);color:rgba(255,255,255,.52);line-height:1.4;display:block;margin-top:clamp(4px,.8vh,8px)}
@media(max-width:800px){.hero-stats{grid-template-columns:repeat(2,1fr);row-gap:clamp(8px,1.2vh,14px)}.hstat{border-right:0}.hstat:nth-child(odd){border-right:1px solid rgba(255,255,255,.1)}}
@media(max-height:640px){.hero-stats{display:none}}
