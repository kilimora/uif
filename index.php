...
.eyebrow{font-family:'EB Garamond',serif;font-style:italic;font-weight:500;font-size:16px;letter-spacing:.01em;color:var(--gold);margin-bottom:20px;display:flex;align-items:center;gap:10px}
...
.tag{font-family:'JetBrains Mono',monospace;font-size:10px;font-weight:600;letter-spacing:.08em;text-transform:uppercase;padding:5px 11px;border-radius:100px;display:inline-flex;align-items:center;gap:6px}
...
.kl-nav-link{font-size:10.5px;font-weight:600;letter-spacing:.13em;text-transform:uppercase;color:rgba(255,255,255,.78);transition:.2s}
...
.kl-dropdown-inner a{display:block;padding:11px 14px;border-radius:9px;font-size:10.5px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:rgba(255,255,255,.8);transition:background .15s,color .15s}
.kl-dropdown-inner a:hover{background:rgba(201,240,77,.1);color:var(--lime)}
.kl-dropdown-inner a small{display:block;font-family:'Ubuntu',sans-serif;text-transform:none;letter-spacing:0;font-weight:400;font-size:11px;color:rgba(255,255,255,.4);margin-top:3px}

/* ── MOBILE DRAWER ACCORDION GROUPS ── */
.mob-group{border-bottom:1px solid rgba(255,255,255,.08)}
.mob-group .mob-group-head{width:100%;display:flex;align-items:center;justify-content:space-between;background:none;border:0;cursor:pointer;font-family:'Ubuntu',sans-serif;font-size:15px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:#fff;padding:16px 0}
...
.mob-group-body a{padding:12px 0 12px 18px!important;font-size:13px!important;color:rgba(255,255,255,.72)!important;border-bottom:0!important}
...
.gate-kicker{font-family:'JetBrains Mono',monospace;font-size:10px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:var(--lime-soft)}
...
.gate-tile h3{color:#fff;font-size:20px;margin:12px 0 10px}
.gate-tile p{color:rgba(255,255,255,.6);font-size:13px;line-height:1.65;flex:1}
.gate-cta{margin-top:18px;font-family:'JetBrains Mono',monospace;font-size:10.5px;font-weight:600;letter-spacing:.08em;text-transform:uppercase;color:#fff;display:inline-flex;align-items:center;gap:6px}
...
.sys-board-tag{font-family:'JetBrains Mono',monospace;font-size:10.5px;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:var(--lime-soft);display:inline-flex;align-items:center;gap:8px}
...
.sys-board-note{font-family:'JetBrains Mono',monospace;font-size:10.5px;color:rgba(255,255,255,.4);letter-spacing:.03em}
...
.sys-status{font-family:'JetBrains Mono',monospace;font-size:9.5px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;padding:5px 10px;border-radius:100px;text-align:center;white-space:nowrap}
...
.sys-main h4{color:#fff;font-size:16px;margin:0 0 4px;font-weight:700}
.sys-main p{color:rgba(255,255,255,.55);font-size:12.5px;line-height:1.5;margin:0;max-width:560px}
.sys-sdg{display:flex;gap:6px;flex-wrap:wrap}
.sys-access{font-family:'JetBrains Mono',monospace;font-size:11px;font-weight:700;letter-spacing:.04em;color:var(--lime-soft);text-align:right;white-space:nowrap;transition:.2s}
...
.sdg-chip{display:inline-flex;align-items:center;gap:8px;padding:5px 13px 5px 5px;border-radius:999px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.12);font-family:'JetBrains Mono',monospace;font-size:9.5px;font-weight:600;letter-spacing:.03em;text-transform:uppercase;color:rgba(255,255,255,.7);white-space:nowrap}
.sdg-chip .sdg-num{width:20px;height:20px;border-radius:6px;display:flex;align-items:center;justify-content:center;font-family:'JetBrains Mono',monospace;font-size:10.5px;font-weight:700;color:#fff;flex-shrink:0}

/* ── IN-PAGE SUBPAGE BAR (used by sections that behave like their own page) ── */
.subpage-bar{display:flex;align-items:center;gap:10px;margin-bottom:34px;font-family:'JetBrains Mono',monospace;font-size:10.5px;letter-spacing:.06em;text-transform:uppercase}
...
.hero::after{content:'';position:absolute;inset:0;background:radial-gradient(ellipse at 30% 20%,rgba(201,240,77,.08),transparent 55%),linear-gradient(180deg,rgba(6,8,5,.5) 0%,rgba(6,8,5,.4) 35%,rgba(6,8,5,.95) 100%)}
.hero-in{position:relative;z-index:2;width:100%;height:100%;display:flex;flex-direction:column;justify-content:center;padding:calc(var(--nav) + 1.6vh) 0 2vh;overflow:hidden;box-sizing:border-box}
.hero-badge{display:inline-flex;align-items:center;gap:8px;font-family:'JetBrains Mono',monospace;font-size:clamp(8.5px,1.05vh,10.5px);font-weight:600;letter-spacing:.13em;text-transform:uppercase;color:var(--lime-soft);border:1px solid rgba(201,240,77,.3);padding:clamp(5px,.9vh,8px) 16px;border-radius:100px;margin-bottom:clamp(10px,1.8vh,26px);flex-shrink:0}
.hero-badge .dot{width:6px;height:6px;border-radius:50%;background:var(--lime);animation:pulse 2s infinite}
@keyframes pulse{0%,100%{opacity:1}50%{opacity:.25}}
.hero h1{font-size:clamp(21px,4.6vh,58px);color:#fff;max-width:1040px;margin-bottom:clamp(8px,1.4vh,20px);font-weight:600;letter-spacing:-.02em;line-height:1.08;flex-shrink:0}
.hero h1 em{font-style:italic;color:var(--lime-soft);font-weight:500}
.hero p.lead{font-family:'EB Garamond',serif;font-style:italic;font-size:clamp(11.5px,1.7vh,17px);color:rgba(255,255,255,.68);max-width:640px;margin-bottom:clamp(12px,2vh,30px);font-weight:400;line-height:1.5;flex-shrink:0}
.hero-cta{display:flex;flex-wrap:wrap;gap:12px;margin-bottom:clamp(14px,2.4vh,36px);flex-shrink:0}
...
.hero-stats{display:grid;grid-template-columns:repeat(4,1fr);gap:0;border-top:1px solid rgba(255,255,255,.14);flex-shrink:0}
.hstat{padding:clamp(9px,1.6vh,20px) 20px 0;border-right:1px solid rgba(255,255,255,.1)}
.hstat:last-child{border-right:0}
.hstat b{display:block;font-family:'JetBrains Mono',monospace;font-size:clamp(13px,2vh,22px);color:var(--lime-soft);font-weight:700;line-height:1}
.hstat span{font-size:clamp(8px,1vh,10.5px);color:rgba(255,255,255,.52);line-height:1.45;display:block;margin-top:clamp(4px,.9vh,9px)}
@media(max-width:800px){.hero-stats{grid-template-columns:repeat(2,1fr);row-gap:clamp(8px,1.4vh,16px)}.hstat{border-right:0}.hstat:nth-child(odd){border-right:1px solid rgba(255,255,255,.1)}}
@media(max-height:560px){.hero-stats{display:none}}



/* ── SECTION HEADS ── */
.stitle{font-size:clamp(28px,3.6vw,46px);font-weight:600;margin-bottom:20px;max-width:780px}
.slead{font-family:'EB Garamond',serif;font-style:italic;font-size:16.5px;color:var(--soft);max-width:660px;margin-bottom:52px;line-height:1.75}
...
.hero video,.hero-in,.hero::after{z-index:2}
...
.ticker-item{font-family:'JetBrains Mono',monospace;font-size:11.5px;font-weight:500;letter-spacing:.04em;color:rgba(255,255,255,.5);display:inline-flex;align-items:center;gap:10px}
.ticker-item b{color:var(--lime-soft);font-weight:700}
.ticker-item .sep{color:var(--gold);opacity:.5}

/* ── TRUSTED FRAMEWORKS MARQUEE ── */
.fw-band{background:var(--cream-warm);padding:22px 0;overflow:hidden;white-space:nowrap;border-top:1px solid var(--rule);border-bottom:1px solid var(--rule)}
.fw-track{display:inline-flex;gap:52px;animation:tickmove 40s linear infinite}
.fw-band:hover .fw-track{animation-play-state:paused}
.fw-item{font-family:'EB Garamond',serif;font-style:italic;font-size:15px;color:var(--mid);display:inline-flex;align-items:center;gap:20px}
.fw-item .sep{color:var(--gold);font-style:normal}
...
.signal-h{font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:.12em;text-transform:uppercase;margin-bottom:22px;display:block}
.signal-half.before .signal-h{color:rgba(255,255,255,.35)}
.signal-half.after .signal-h{color:var(--lime-soft)}
.signal-row{display:flex;align-items:center;justify-content:space-between;padding:11px 0;border-bottom:1px solid rgba(255,255,255,.07);font-family:'JetBrains Mono',monospace;font-size:12px}
...
.signal-caption{font-family:'EB Garamond',serif;font-style:italic;font-size:15px;margin-top:22px;line-height:1.6}
...
.stat-interlude p{font-family:'JetBrains Mono',monospace;font-size:12px;letter-spacing:.1em;text-transform:uppercase;color:rgba(255,255,255,.4);margin-top:20px}
...
.sdg-node small{display:block;margin-top:10px;font-family:'JetBrains Mono',monospace;font-size:9.5px;letter-spacing:.06em;text-transform:uppercase;color:var(--soft);text-align:center;line-height:1.4}
...
.sdg-caption{text-align:center;font-family:'EB Garamond',serif;font-style:italic;color:var(--soft);font-size:14px;margin-top:36px}
...
.stake-pill{font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:.05em;text-transform:uppercase;padding:9px 17px;border:1px solid var(--rule);border-radius:999px;color:var(--mid);background:var(--cream);white-space:nowrap}
...
.stake-card .stake-tag{font-family:'JetBrains Mono',monospace;font-size:9.5px;letter-spacing:.06em;text-transform:uppercase;color:var(--gold)}
.stake-card h4{font-size:19px;margin:7px 0 4px;color:var(--void)}
.stake-card .stake-sub{font-size:12px;color:var(--soft);font-style:italic;margin-bottom:14px;font-family:'EB Garamond',serif}
.stake-card ul{display:flex;flex-direction:column;gap:8px}
.stake-card li{font-size:12.5px;line-height:1.5;color:var(--mid);padding-left:15px;position:relative}
...
.stake-defines h5{font-family:'EB Garamond',serif;font-size:17px;letter-spacing:.02em;margin-bottom:10px;color:var(--void)}
.stake-defines p{font-size:13.5px;color:var(--mid);line-height:1.65;max-width:280px;margin:0 auto}
.stake-cta{display:inline-flex;align-items:center;gap:8px;margin-top:44px;font-family:'JetBrains Mono',monospace;font-size:11.5px;letter-spacing:.05em;text-transform:uppercase;color:var(--forest);border-bottom:1px solid var(--forest);padding-bottom:3px}
...
@media(max-width:640px){.mindmap-wrap{padding:4px}.mindmap-block .slead{font-size:13.5px}}
...
@media(max-width:560px){.stake-grid{grid-template-columns:1fr}.stake-pills{gap:8px}.stake-pill{font-size:9px;padding:7px 13px}}
...
.sdg-un-badge small{display:block;margin-top:10px;font-family:'JetBrains Mono',monospace;font-size:9.5px;letter-spacing:.06em;text-transform:uppercase;color:var(--soft)}
...
.sdg-goal small{display:block;margin-top:9px;font-family:'JetBrains Mono',monospace;font-size:9px;letter-spacing:.05em;text-transform:uppercase;color:var(--soft);text-align:center;line-height:1.4}
@media(max-width:560px){.sdg-goals-2x4{max-width:360px;gap:14px}}

/* ── CALLIGRAPHY BLOCK (signature type moment) ── */
.calligraphy{font-family:'EB Garamond',serif;font-style:italic;font-weight:500;font-size:clamp(22px,2.6vw,34px);line-height:1.4;color:var(--forest);max-width:820px;margin:40px 0;letter-spacing:.002em}
.calligraphy.on-void{color:var(--lime-soft)}
.calligraphy .mark{color:var(--gold)}
.calligraphy.on-void .mark{color:var(--lime)}

.pull{position:relative;background:var(--cream-warm);border:1px solid var(--rule);border-radius:14px;padding:30px 30px 26px;margin:28px 0;font-family:'EB Garamond',serif;font-style:italic;font-size:17px;color:var(--ink)}
...
.challenge-grid p{margin-bottom:16px;color:var(--mid);font-size:15px}
...
.jdot{width:60px;height:60px;border-radius:50%;background:var(--void);border:2px solid var(--gold);color:var(--lime-soft);display:flex;align-items:center;justify-content:center;font-family:'JetBrains Mono',monospace;font-weight:700;font-size:13px;flex-shrink:0;z-index:1}
.jbody h3{font-size:15px;font-weight:700;text-transform:uppercase;letter-spacing:.1em;color:var(--gold);margin-bottom:12px;font-family:'JetBrains Mono',monospace}
.jbody .calligraphy{margin:6px 0 16px}
.jbody p.jnote{font-size:14px;color:var(--mid);max-width:640px}
@media(max-width:700px){.jitem{grid-template-columns:44px 1fr;gap:18px}.jdot{width:44px;height:44px;font-size:11px}.jline{left:21px}}

/* ── PRODUCT / SOLUTION CARDS ── */
.sol-grid{display:grid;grid-template-columns:repeat(5,1fr);gap:20px}
.sol-card{background:rgba(201,240,77,.04);border:1px solid rgba(201,240,77,.14);border-radius:var(--r-card);padding:32px 24px}
.sol-num{font-family:'JetBrains Mono',monospace;font-size:12px;color:var(--lime);margin-bottom:18px;letter-spacing:.04em}
.sol-card h4{font-size:19px;margin-bottom:10px;color:#fff}
.sol-card p{font-size:13.5px;color:rgba(255,255,255,.55);line-height:1.65}
...
.credit-spotlight{position:relative;overflow:hidden;display:grid;grid-template-columns:1.05fr .95fr;gap:44px;margin-top:28px;padding:36px 40px;border-radius:var(--r-card);background:rgba(201,240,77,.05);border:1px solid rgba(201,240,77,.18)}
...
.credit-spotlight::after{content:'✦';position:absolute;top:16px;right:26px;color:var(--lime);font-size:13px;opacity:.55}
.credit-spotlight h4{font-family:'EB Garamond',serif;font-size:23px;color:#fff;margin:8px 0 14px;line-height:1.25}
.credit-spotlight .cs-left p{font-size:14px;color:rgba(255,255,255,.62);line-height:1.75}
...
.cs-list li{font-size:13px;line-height:1.6;color:rgba(255,255,255,.62);padding-left:18px;position:relative}
...
.mf-kicker{font-family:'JetBrains Mono',monospace;font-size:10.5px;letter-spacing:.05em;text-transform:uppercase;color:var(--lime);margin-bottom:4px}
.mf-sub{font-family:'EB Garamond',serif;font-style:italic;font-size:13px;color:rgba(255,255,255,.45);margin-bottom:16px}
.mf-card ul{display:flex;flex-direction:column;gap:12px}
.mf-card li{font-size:12.5px;line-height:1.6;color:rgba(255,255,255,.6)}
...
.sc-note{font-family:'EB Garamond',serif;font-style:italic;font-size:13px;color:rgba(255,255,255,.45)}
.sc-caption{margin-top:16px;font-size:12px;color:rgba(255,255,255,.4);font-family:'JetBrains Mono',monospace;letter-spacing:.02em}
...
.traj-yr{font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:.06em;text-transform:uppercase;color:var(--lime);margin-bottom:10px}
.traj-step h5{font-family:'EB Garamond',serif;font-size:18px;color:#fff;margin-bottom:10px;line-height:1.3}
.traj-step p{font-size:12.5px;line-height:1.65;color:rgba(255,255,255,.58)}
.traj-arrow{display:flex;align-items:center;justify-content:center;padding:0 14px;color:var(--lime);font-size:20px;opacity:.55}
.traj-close{margin-top:26px;font-family:'EB Garamond',serif;font-style:italic;font-size:15.5px;color:rgba(255,255,255,.68);max-width:640px;line-height:1.6}
...
.chart-card h4{font-size:13px;letter-spacing:.06em;text-transform:uppercase;color:var(--soft);margin-bottom:24px;font-family:'JetBrains Mono',monospace;font-weight:600}
.bar-row{margin-bottom:20px}
.bar-row:last-child{margin-bottom:0}
.bar-label{display:flex;justify-content:space-between;font-size:12.5px;color:var(--mid);margin-bottom:7px;font-weight:500}
.bar-label b{color:var(--forest);font-family:'JetBrains Mono',monospace;font-size:14px}
...
.chart-note{font-size:11px;color:var(--soft);margin-top:22px;line-height:1.6;font-style:italic;font-family:'EB Garamond',serif}
...
.pillar .pnum{font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--lime);margin-bottom:14px}
.pillar h4{font-size:15px;color:#fff;margin-bottom:8px}
.pillar p{font-size:12px;color:rgba(255,255,255,.5);line-height:1.6}
...
.exec-item b{display:block;color:#fff;font-family:'EB Garamond',serif;font-size:16px;margin-bottom:4px}
.exec-item span{font-size:12.5px;color:rgba(255,255,255,.55)}
...
.eco-node b{display:block;font-family:'EB Garamond',serif;font-weight:600;font-style:italic;font-size:13.5px;line-height:1.25;color:var(--void)}
.eco-node.below{transform:translate(-50%,14px)}
.eco-node.root{transform:translate(-50%,14px)}
.eco-node.root b{font-size:18px;color:var(--forest);font-style:normal;font-weight:700}
...
.eco-legend-item{display:flex;align-items:center;gap:8px;font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:.05em;text-transform:uppercase;color:var(--mid)}
...
.eco-row h4{font-family:'EB Garamond',serif;font-size:16px;margin-bottom:6px;color:var(--forest)}
.eco-row p{font-size:13px;color:var(--soft);line-height:1.65}
@media(max-width:760px){.eco-list{grid-template-columns:1fr}.eco-node{width:104px}.eco-node b{font-size:12px}}
...
.sd-ev-tag{font-family:'JetBrains Mono',monospace;font-size:9.5px;letter-spacing:.08em;text-transform:uppercase;color:var(--lime);margin-bottom:10px}
.sd-ev-card p{font-size:13.5px;line-height:1.75;color:rgba(255,255,255,.68)}
.sd-ev-src{margin-top:12px;font-size:11px;color:rgba(255,255,255,.35);font-family:'JetBrains Mono',monospace}
...
.sd-dom-card h5{font-size:17px;margin-bottom:8px;color:#fff}
.sd-dom-card p{font-size:12.5px;color:rgba(255,255,255,.55);line-height:1.65}
...
.elig-check{flex:none;width:26px;height:26px;border-radius:50%;background:var(--forest);color:#fff;display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700}
.elig-card h5{font-size:14px;color:var(--ink);margin:0 0 4px;font-weight:700}
.elig-card p{font-size:12.5px;color:var(--mid);line-height:1.5;margin:0}
...
.core-col.open{background:var(--void-2,#12150E);border-left:3px solid var(--lime)}
.core-col.commercial{background:rgba(255,255,255,.02);border-left:3px solid rgba(255,255,255,.25)}
.core-tag{font-family:'JetBrains Mono',monospace;font-size:10.5px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;display:inline-block;margin-bottom:10px}
.core-col.open .core-tag{color:var(--lime-soft)}
.core-col.commercial .core-tag{color:rgba(255,255,255,.45)}
.core-col h4{color:#fff;font-size:19px;margin-bottom:10px}
.core-col p.core-lead{font-size:13px;color:rgba(255,255,255,.55);line-height:1.6;margin-bottom:18px}
.core-col ul{list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:11px}
.core-col li{font-size:13px;color:rgba(255,255,255,.75);line-height:1.55;padding-left:20px;position:relative}
...
.sd-eco-kicker{font-family:'JetBrains Mono',monospace;font-size:9px;letter-spacing:.07em;text-transform:uppercase;color:var(--gold-bright);margin-bottom:8px}
.sd-eco-card h5{font-size:15.5px;margin-bottom:8px;color:#fff}
.sd-eco-card p{font-size:12px;color:rgba(255,255,255,.55);line-height:1.6}
.sd-mech-strip{display:flex;flex-wrap:wrap;gap:10px;margin-top:26px}
.sd-mech-pill{font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:.05em;text-transform:uppercase;padding:9px 17px;border:1px solid rgba(255,255,255,.15);border-radius:999px;color:rgba(255,255,255,.62);white-space:nowrap}
...
.sd-path-step .sd-pn{font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--lime);font-weight:700;margin-bottom:8px}
.sd-path-step h5{font-size:15px;margin-bottom:7px;color:#fff}
.sd-path-step p{font-size:11.5px;color:rgba(255,255,255,.55);line-height:1.6}
...
.sd-gap-col h4{font-size:19px;margin-bottom:16px;color:#fff}
.sd-gap-col ul{display:flex;flex-direction:column;gap:12px}
.sd-gap-col li{font-size:13px;line-height:1.6;color:rgba(255,255,255,.65);padding-left:16px;position:relative;list-style:none}
...
.policy-card p{font-size:12.5px;color:var(--soft);line-height:1.6}
...
.rm-dot{width:40px;height:40px;border-radius:50%;background:var(--forest);color:#fff;display:flex;align-items:center;justify-content:center;font-family:'JetBrains Mono',monospace;font-weight:700;font-size:11px;flex-shrink:0;z-index:1}
.rm-body h4{font-size:17px;margin-bottom:6px}
.rm-body p{font-size:13.5px;color:var(--mid)}
...
.hh-card{background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.16);border-radius:14px;padding:22px 20px}
.hh-card b{display:block;font-family:'EB Garamond',serif;font-style:italic;font-weight:600;font-size:18px;color:var(--lime-soft);margin-bottom:8px;line-height:1.25}
.hh-card span{font-size:12px;color:rgba(255,255,255,.62);line-height:1.55}
...
.os-badge b{display:block;font-size:12.5px;font-weight:700;color:var(--void)}
.os-badge span{font-size:10.5px;color:var(--soft)}
.license-table{width:100%;border-collapse:collapse;margin-top:10px}
.license-table td{padding:14px 0;border-bottom:1px solid var(--rule);font-size:13.5px;vertical-align:top}
...
.contact-card{background:var(--forest);border:1px solid rgba(201,240,77,.28);border-radius:100px;padding:14px 14px 14px 30px;display:flex;flex-direction:column;gap:0}
...
.contact-row a{font-weight:700;font-size:15px;color:#fff}
.contact-row small{display:block;font-size:10.5px;letter-spacing:.1em;text-transform:uppercase;color:rgba(255,255,255,.55);margin-bottom:3px}
...
.f-logo-txt{display:flex;flex-direction:column;font-family:'EB Garamond',serif;font-weight:700;font-size:32px;line-height:1.05;letter-spacing:-.01em;color:#fff}
.f-tag{font-family:'EB Garamond',serif;font-style:italic;font-size:14.5px;color:rgba(255,255,255,.35);line-height:1.75;max-width:320px}
.f-head{font-size:9.5px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;color:var(--lime-dim);margin-bottom:12px}
.f-col a,.f-col span{display:block;font-size:12.5px;color:rgba(255,255,255,.55);margin-bottom:12px;line-height:1.5}
.f-col a:hover{color:var(--lime)}
.f-bottom{display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px;padding:18px 0 22px;font-size:11px;color:rgba(255,255,255,.35)}
...
.mob-drawer a{display:block;font-size:15px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:#fff;padding:16px 0;border-bottom:1px solid rgba(255,255,255,.08)}
.mob-close{position:absolute;top:28px;right:28px;background:none;border:0;color:#fff;font-size:22px;cursor:pointer}
...
.subpage-bar{display:flex;align-items:center;gap:10px;margin-bottom:30px;font-family:'JetBrains Mono',monospace;font-size:10.5px;letter-spacing:.06em;text-transform:uppercase}
.subpage-crumb{color:rgba(255,255,255,.45);transition:.2s}
.subpage-crumb:hover{color:var(--lime)}
.subpage-crumb.is-current{color:var(--lime-soft)}
.subpage-sep{color:rgba(255,255,255,.25)}
.hero-badge{display:inline-flex;align-items:center;gap:8px;font-family:'JetBrains Mono',monospace;font-size:10.5px;font-weight:600;letter-spacing:.13em;text-transform:uppercase;color:var(--lime-soft);border:1px solid rgba(201,240,77,.3);padding:8px 16px;border-radius:100px;margin-bottom:26px}
.hero-badge .dot{width:7px;height:7px;border-radius:50%;background:var(--lime);display:inline-block}
.papi-hero h1{font-size:clamp(34px,5vw,58px);max-width:820px;line-height:1.12;margin-bottom:22px}
.papi-hero .lead{font-family:'EB Garamond',serif;font-style:italic;font-size:18px;color:rgba(255,255,255,.62);max-width:640px;margin-bottom:34px;line-height:1.6}
.papi-hero .slead{font-family:'EB Garamond',serif;font-style:italic;font-size:17px;color:rgba(255,255,255,.62);line-height:1.7}
...
.hstat b{display:block;font-family:'JetBrains Mono',monospace;font-size:26px;color:var(--lime-soft);font-weight:700}
.hstat span{font-size:11px;letter-spacing:.04em;text-transform:uppercase;color:rgba(255,255,255,.45);font-family:'JetBrains Mono',monospace}

/* ── SDG ALIGNMENT CHIPS (official UN SDG colours) ── */
.sdg-chip.sdg-chip--sm{margin-top:12px}
...
.fx-row{display:flex;align-items:center;gap:34px;flex-wrap:wrap;font-family:'JetBrains Mono',monospace;font-size:12px}
.fx-tag{display:inline-flex;align-items:center;gap:6px;color:var(--lime);font-weight:700;letter-spacing:.08em;text-transform:uppercase;font-size:10px}
...
.fx-pair b{color:#fff}
.fx-updated{color:rgba(255,255,255,.35);font-size:10.5px;margin-left:auto}
...
.defines-item h5{font-size:19px;margin-bottom:10px}
.defines-item p{font-size:13.5px;color:rgba(255,255,255,.55);line-height:1.7;max-width:280px;margin:0 auto}
@media(max-width:760px){.defines-grid{grid-template-columns:1fr;gap:36px}}

/* ── FEATURE GRID (photo cards) ── */
.feat-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:20px;margin-top:10px}
...
.feat-tag{font-family:'JetBrains Mono',monospace;font-size:9px;letter-spacing:.06em;text-transform:uppercase;color:var(--lime)}
.feat-card h4{font-size:17px;margin:7px 0 8px}
.feat-card p{font-size:12px;line-height:1.6;color:rgba(255,255,255,.55)}
@media(max-width:980px){.feat-grid{grid-template-columns:1fr 1fr}}
@media(max-width:560px){.feat-grid{grid-template-columns:1fr}}

/* ── LIVE DEMO ── */
.demo-panel{background:var(--void-2);border-left:3px solid var(--lime);border-radius:var(--r-card);padding:40px;margin-top:16px}
...
.demo-factor-head span{font-family:'JetBrains Mono',monospace;font-size:11.5px;font-weight:700;color:#fff}
.demo-factor-head b{font-family:'JetBrains Mono',monospace;font-size:13px;color:var(--lime)}
...
.demo-total-label{font-family:'JetBrains Mono',monospace;font-size:10.5px;letter-spacing:.06em;text-transform:uppercase;color:rgba(255,255,255,.5);margin-bottom:10px}
.demo-total-num{font-family:'EB Garamond',serif;font-weight:600;font-size:64px;color:var(--lime-soft);line-height:1}
.demo-total-num span{font-size:26px;color:rgba(255,255,255,.4)}
.demo-tier{margin-top:14px;font-family:'JetBrains Mono',monospace;font-size:12px;letter-spacing:.04em;text-transform:uppercase;padding:8px 16px;border-radius:100px;display:inline-block}
...
.demo-note{margin-top:18px;font-size:11.5px;color:rgba(255,255,255,.4);line-height:1.6}
.demo-disclaimer{margin-top:28px;font-family:'EB Garamond',serif;font-style:italic;font-size:12.5px;color:rgba(255,255,255,.35)}
.demo-banner{display:flex;align-items:flex-start;gap:13px;background:rgba(230,168,50,.07);border-left:3px solid var(--gold-bright);border-radius:0 12px 12px 0;padding:16px 20px;margin:22px 0 8px}
.demo-banner svg{flex:none;margin-top:2px}
.demo-banner-label{font-family:'JetBrains Mono',monospace;font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--gold-bright);margin-bottom:5px}
.demo-banner p{font-family:'JetBrains Mono',monospace;font-size:12px;line-height:1.6;color:rgba(255,255,255,.65);margin:0}

/* ── API DOCS ── */
.doc-panel{display:grid;grid-template-columns:1fr 1fr;gap:24px;margin-top:10px}
...
.code-block .cb-label{font-family:'JetBrains Mono',monospace;font-size:9.5px;letter-spacing:.06em;text-transform:uppercase;color:rgba(255,255,255,.4);margin-bottom:14px}
.code-block pre{font-family:'JetBrains Mono',monospace;font-size:11.5px;line-height:1.7;color:#DFF593;white-space:pre}
...
.pill{font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:.05em;text-transform:uppercase;padding:9px 17px;border:1px solid rgba(255,255,255,.15);border-radius:999px;color:rgba(255,255,255,.6);white-space:nowrap}
...
.pillar .pnum{font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--lime);margin-bottom:14px}
.pillar h4{font-size:15px;color:#fff;margin-bottom:8px}
.pillar p{font-size:12px;color:rgba(255,255,255,.5);line-height:1.6;flex:1}
.pillar .sdg-chip{margin-top:14px;align-self:flex-start}
...
@media(max-width:560px){.sd-eco-grid{grid-template-columns:1fr}}
.sd-eco-card{background:var(--void-2,#12150E);border-radius:12px;padding:20px 22px}
.sd-eco-kicker{font-family:'JetBrains Mono',monospace;font-size:9px;letter-spacing:.07em;text-transform:uppercase;color:var(--lime);margin-bottom:8px}
.sd-eco-card h5{font-size:15.5px;margin-bottom:8px;color:#fff}
.sd-eco-card p{font-size:12px;color:rgba(255,255,255,.55);line-height:1.6}
.sd-mech-strip{display:flex;flex-wrap:wrap;gap:10px;margin-top:26px}
.sd-mech-pill{font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:.05em;text-transform:uppercase;padding:9px 17px;border:1px solid rgba(255,255,255,.15);border-radius:999px;color:rgba(255,255,255,.62);white-space:nowrap}
.pull{position:relative;background:var(--void-2,#12150E);border-left:3px solid var(--lime);border-radius:0 14px 14px 0;padding:30px 30px 26px;margin:28px 0;font-family:'EB Garamond',serif;font-style:italic;font-size:17px;color:rgba(255,255,255,.82)}
...
body[data-page]:not([data-page="home"]) .btn{padding:14px 26px;font-size:11.5px;gap:8px}
...
.voice-quote{font-family:'EB Garamond',serif;font-style:italic;font-size:15.5px;line-height:1.7;color:rgba(255,255,255,.82);flex:1}
.voice-attr{display:flex;align-items:center;gap:10px;margin-top:18px;padding-top:16px;border-top:1px solid rgba(255,255,255,.08)}
.voice-avatar{width:36px;height:36px;border-radius:50%;background:rgba(201,240,77,.14);color:var(--lime);display:flex;align-items:center;justify-content:center;font-family:'JetBrains Mono',monospace;font-size:12px;font-weight:700;flex-shrink:0}
.voice-name{font-size:13px;color:#fff;font-weight:600}
.voice-role{font-size:11px;color:rgba(255,255,255,.45);font-family:'JetBrains Mono',monospace;text-transform:uppercase;letter-spacing:.04em}

/* ── Child Aid Alignment — "north star" goal band ── */
.goal-band{text-align:center;padding:56px 40px;background:rgba(95,180,224,.06);border:1px solid rgba(95,180,224,.2);border-radius:var(--r-card)}
.goal-num{font-family:'EB Garamond',serif;font-weight:600;font-size:clamp(56px,8vw,104px);color:var(--childblue);line-height:1}
.goal-label{font-family:'JetBrains Mono',monospace;font-size:12px;letter-spacing:.08em;text-transform:uppercase;color:rgba(255,255,255,.55);margin-top:12px}
.goal-sub{font-family:'EB Garamond',serif;font-style:italic;color:rgba(255,255,255,.6);max-width:560px;margin:14px auto 0;font-size:15px;line-height:1.6}
...
body[data-page="sport-development"] .papi-hero h1{
  font-size:clamp(18px,3.2vh,46px)!important;margin-bottom:clamp(6px,1.1vh,14px)!important;
...
body[data-page="sport-development"] .papi-hero .hstat b{font-size:clamp(12px,1.7vh,26px)}
...
body[data-page="financial-enablement"] .papi-hero h1{font-size:clamp(18px,3.2vh,46px)!important;margin-bottom:clamp(6px,1.1vh,14px)!important;line-height:1.12;flex-shrink:0}
...
body[data-page="climate-resilience"] .papi-hero h1{
  font-size:clamp(17px,2.9vh,42px)!important;margin-bottom:clamp(5px,1vh,14px)!important;
...
body[data-page="climate-resilience"] .papi-hero .hstat b{font-size:clamp(11px,1.6vh,24px)}
...
.flow-counter{position:fixed;right:26px;bottom:26px;z-index:70;font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:.1em;color:rgba(255,255,255,.75);display:flex;align-items:center;gap:8px;pointer-events:none;mix-blend-mode:difference;transition:opacity .4s ease}
.flow-counter b{color:#fff;font-size:16px;font-weight:600}
.flow-counter i{font-style:normal;opacity:.5}
.flow-scroll-cue{position:fixed;left:50%;bottom:30px;transform:translateX(-50%);z-index:70;font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:rgba(255,255,255,.8);display:flex;flex-direction:column;align-items:center;gap:10px;pointer-events:none;transition:opacity .5s ease;mix-blend-mode:difference}
.flow-scroll-cue::after{content:'';width:1px;height:32px;background:linear-gradient(rgba(255,255,255,.9),transparent)}
.flow-scroll-cue.hide{opacity:0}
@media(max-width:640px){.flow-counter,.flow-scroll-cue{display:none}}
...
.h-gallery .h-slide-cap{position:absolute;left:0;right:0;bottom:0;padding:18px 20px;font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:.06em;color:#fff;background:linear-gradient(0deg,rgba(0,0,0,.7),transparent)}
.h-gallery-nav{display:flex;justify-content:center;gap:10px;margin-top:18px}
...
.h-gallery-arrow{position:absolute;top:50%;transform:translateY(-50%);width:44px;height:44px;border-radius:50%;background:rgba(10,12,9,.65);border:1px solid rgba(255,255,255,.2);color:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer;z-index:5;backdrop-filter:blur(4px);font-size:18px}
...
<section class="hero" id="home">
  ...
  <div class="hero-in wrap">
    <div class="hero-badge"><span class="dot"></span> Innovation Engineered Around A Child</div>
    <h1>Community technology. <em>Built so a child eats, learns and stays well because of it.</em></h1>
    <p class="lead">AgriKonnekt pairs climate sensors, verified farmer identity and market access into one system, engineered with the rigour of consumer technology and measured only by what changes for the child in the household behind every harvest.</p>
    <div class="hero-cta">
    ...
    <div class="hero-stats">
      <div class="hstat"><b>75%+</b><span>of Kenya's food comes from smallholder farms, the households most rural children are born into</span></div>
      <div class="hstat"><b>30%+</b><span>of harvested value lost before market, value that could pay a school fee or a clinic visit</span></div>
      <div class="hstat"><b>ONE</b><span>system built to put a child's wellbeing where every farming decision starts</span></div>
...
<div class="fw-band">
  <div class="fw-track">
    <span class="fw-item">UNICEF Innovation Fund <span class="sep">✦</span></span>
    <span class="fw-item">African Union Agenda 2063 <span class="sep">✦</span></span>
    <span class="fw-item">Malabo Declaration <span class="sep">✦</span></span>
    <span class="fw-item">Kenya Vision 2030 <span class="sep">✦</span></span>
    <span class="fw-item">EAC Vision 2050 <span class="sep">✦</span></span>
    <span class="fw-item">Open Source Initiative <span class="sep">✦</span></span>
    <span class="fw-item">UN Sustainable Development Goals <span class="sep">✦</span></span>
    <span class="fw-item">UNICEF Innovation Fund <span class="sep">✦</span></span>
    <span class="fw-item">African Union Agenda 2063 <span class="sep">✦</span></span>
    <span class="fw-item">Malabo Declaration <span class="sep">✦</span></span>
    <span class="fw-item">Kenya Vision 2030 <span class="sep">✦</span></span>
...
<section class="section" id="challenge">
  <div class="wrap reveal">
    ...
    <div class="challenge-grid">
      <div>
        <p>More than three out of every four meals in Kenya start on a smallholder farm, yet the families growing that food are usually last in line for reliable markets, fair financing, or even a warning before the weather turns against them, as droughts arrive early, livestock fall ill without warning, and the soil wears thin over the years. When a harvest loses a third of its value before it ever reaches a buyer, that loss becomes a missed meal, a school fee pushed back another month, or a clinic visit delayed again, a number on a balance sheet translating directly into a family's daily reality.</p>
        <p>Every one of those shocks eventually reaches the kitchen table, landing hardest on the smallest person sitting at it. Weather signals, farming advice, financing, and market access have historically lived in separate systems built in isolation from one another, leaving farmers to piece everything together alone while children absorb whatever falls through the gaps between them. This is why every harvest inside the system carries a traceable record of its own labour conditions, keeping a clear line between the work a child does and the work that belongs to someone older.</p>
        ...
        <p>AgriKonnekt exists to close exactly that gap, one connected system built for the families the formal economy keeps overlooking, designed around a single governing principle: a child's daily wellbeing sits at the centre of every decision the platform makes, built into the architecture from the outset rather than hoped for as an afterthought.</p>
      </div>
...
<section class="section section-void" id="explore-more" style="padding-top:70px;padding-bottom:70px">
  <div class="wrap reveal">
    ...
    <h2 style="font-size:clamp(22px,3vw,32px);max-width:760px;margin-bottom:12px;color:#fff">Five more doors into the same mission</h2>
    <p class="slead" style="max-width:660px">AgriKonnekt is the harvest. What is happening behind the numbers in real time, how this fits any organisation funding a child's wellbeing, what a child does after school, whether that household gets a warning before the next flood or heat wave, and whether a child's own risk is trending up or down before anyone has to ask, all matter just as much. A verified, traceable household record is what opens every one of these doors, protecting a child from exploitative labour first, then carrying that same household into finance, education, sport, climate resilience, and one composite score for the household's whole situation. Each door below opens onto its own page.</p>
    <div class="gate-grid">
      ...
      <a href="/sport-development" class="gate-tile gate-tile--sport">
        ...
        <p>Courts, coaches, mentors, arts and vocational pathways, the whole life a child builds outside the classroom, and outside the farm too. See the evidence, the ecosystem, and the gaps we are closing.</p>
        <div class="sdg-strip">
          <span class="sdg-chip"><span class="sdg-num" style="background:#4C9F38">3</span>Health</span>
          <span class="sdg-chip"><span class="sdg-num" style="background:#FD9D24">11</span>Community</span>
  ...
  <div class="wrap reveal">
    <div style="display:flex;justify-content:center;margin-bottom:8px">
      <svg width="150" height="140" viewBox="0 0 240 220" aria-hidden="true">
        ...
        <path d="M120,150 C116,110 128,80 120,42" fill="none" stroke="var(--forest)" stroke-width="2.4" stroke-linecap="round"/>
    ...
    <p class="slead" style="text-align:center;margin-left:auto;margin-right:auto">Seven chapters trace the same journey every pilot family makes, from a child waking up to a farm nobody can vouch for, to a piece of technology the next county can simply hand to its own children, no permission needed.</p>
    ...
    <div class="journey">
      ...
      <div class="jitem">
        ...
        <div class="jbody">
          ...
          <p class="jnote">No sensor, ledger or lender has yet recorded anything about this farm. Every decision the household makes this year will be made on memory and guesswork rather than evidence, and the child's routine, school fees, meals, medical care, will move with whatever the season decides.</p>
        </div>
      </div>
      ...
      <div class="jitem">
        ...
        <div class="jbody">
          ...
          <div class="calligraphy">Insurers, buyers and lenders cannot see a farm that has no record, so its risk is priced onto the family instead of the market.</div>
          <p class="jnote">This is exactly the gap AgriKonnekt was built to close. Without a track record anyone can verify, a household cannot get insurance, cannot borrow on fair terms, and cannot prove to a buyer that what they are growing is worth paying properly for.</p>
        </div>
      </div>
      ...
      <div class="jitem">
        ...
        <div class="jbody">
          ...
          <p class="jnote">Low cost IoT sensors, satellite imagery and drone supported diagnostics begin tracking soil condition, crop health, livestock risk and weather exposure. Findings are delivered back through low bandwidth dashboards and SMS, built for the connectivity that actually exists in rural Kenya rather than the connectivity a lab assumes.</p>
        </div>
      </div>
...
<div class="flow-divider" style="background:var(--void)">
  <svg viewBox="0 0 1240 64" preserveAspectRatio="none" aria-hidden="true"><path d="M0 30 C 240 58, 380 4, 600 32 S 980 58, 1240 30" fill="none" stroke="var(--lime)" stroke-width="1.2" stroke-dasharray="1 5" opacity=".5"/></svg>
</div>
...
<section class="section section-void" id="product">
  <div class="wrap reveal">
    ...
    <div style="display:flex;align-items:center;gap:16px;flex-wrap:wrap;margin:22px 0 30px;padding:16px 20px;background:rgba(255,255,255,.03);border-radius:12px">
      <span style="font-family:'JetBrains Mono',monospace;font-size:10.5px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--lime-soft);white-space:nowrap">Live Product</span>
      <span style="color:rgba(255,255,255,.6);font-size:13px;flex:1;min-width:220px">AgriKonnekt already runs as a live commercial platform, onboarding real households and cooperatives, at <strong style="color:#fff">agrikonnekt.kilimora.africa</strong>. This site documents the open, publicly fundable layer underneath that platform, itself a proven system already in operation.</span>
    ...
    <div class="chart-card" style="background:var(--void-2);margin-bottom:34px">
      ...
      <p style="font-size:13px;color:rgba(255,255,255,.55);margin-bottom:16px">That fragmented stack is exactly what already exists, and it is exactly the gap the problem statement describes. Each tool below solves one slice well, in complete isolation from the other three.</p>
    ...
    <div class="credit-spotlight fb-zone">
      <div class="cs-left">
        ...
        <p>Smallholder households without documented income are the population every formal lender already writes off, and that exclusion is exactly where risk concentrates around a child. When a shock hits, a rejected loan application or a bad season with no cushion, an unbanked household turns to whatever credit it can find: informal lenders charging extortionate rates, a distress sale of livestock, or pulling a child out of school to close the gap. A credit score functions here as the mechanism standing between a bad season and a child's future being spent to cover it.</p>
        <p style="margin-top:16px">Financial inclusion as a sector has earned some scepticism, and rightly so: broad reviews of access to credit programmes have found effects that are small and inconsistent, while savings consistently show the more reliable gains for a poor household. This system was built with that evidence in mind. Cooperative and group savings sit on equal footing with credit signals, treated as genuine indicators in their own right, and the score exists purely to widen what a household can already prove about itself, staying fair by measuring existing strength rather than manufacturing appetite for debt a family cannot carry.</p>
        <p style="margin-top:16px">The real innovation lies in the data source itself, deliberately spread across multiple signals rather than resting on one. A rural household without a bank account almost always has a phone, often belongs to an informal savings group, and pays for utilities or a solar unit on some kind of schedule. <strong style="color:#fff">Mobile money history, airtime patterns, cooperative savings, and pay as you go repayment</strong> already exist for nearly every one of them, generated automatically, difficult to fake, and updating in real time, a living record where a bank statement for this population typically never existed. Spreading the score across eight independent signals keeps it fair when any single signal goes quiet for a season.</p>
      </div>
      <div class="cs-right">
        <ul class="cs-list">
    ...
    <div class="metrics-framework fb-zone">
      ...
      <div class="scorecard-block">
        ...
        <svg viewBox="0 0 598 418" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;margin-top:18px">
...
<text x="598" y="406" text-anchor="end" font-family="JetBrains Mono, monospace" font-size="22" font-weight="700" fill="var(--lime)">100<tspan fill="rgba(255,255,255,.45)" font-size="15" font-weight="500"> / 120</tspan></text>
      ...
      <div class="traj-wrap">
        ...
        <h3 style="font-family:'EB Garamond',serif;font-size:24px;color:#fff;margin:8px 0 6px;line-height:1.3;max-width:600px">One household, three seasons, the same score doing more each year</h3>
        <p style="color:rgba(255,255,255,.55);max-width:640px;font-size:13.5px;line-height:1.7">This unfolds continuously rather than on a single form filled out once, the same twelve metrics compounding as a household's record deepens and unlocking more each year.</p>
    ...
    <h3 style="font-size:19px;color:#fff;margin:64px 0 8px;font-family:'JetBrains Mono',monospace;font-weight:600;letter-spacing:.02em">The same farm, seen two ways</h3>
    <p style="color:rgba(255,255,255,.5);max-width:620px;margin-bottom:28px;font-size:14px">Every institution downstream of a farmer, a lender, an insurer, a buyer, is really just asking one question. Can this be trusted. Before verification, the honest answer is silence.</p>
...
<section class="section" id="impact">
  <div class="wrap reveal">
    ...
    <h3 style="font-size:22px;margin-bottom:6px;text-align:center">Eight goals, held together by one shared mandate</h3>
    ...
    <div class="eco-tree">
      <svg viewBox="0 0 1000 760" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
        ...
        <g fill="none" stroke-width="1.4" opacity=".55">
          <path stroke="var(--forest)" d="M500,380 L500,90"/>
          <path stroke="var(--forest)" d="M500,380 L776.4,157.9"/>
        ...
        <g fill="none" stroke-width="1.2" opacity=".4">
          <path stroke="var(--forest)" d="M500,90 L776.4,157.9"/>
...
<div class="flow-divider" style="background:var(--forest)">
  <svg viewBox="0 0 1240 64" preserveAspectRatio="none" aria-hidden="true"><path d="M0 30 C 200 2, 420 58, 640 28 S 1020 2, 1240 30" fill="none" stroke="var(--lime)" stroke-width="1.2" stroke-dasharray="1 5" opacity=".55"/></svg>
</div>
...
<section class="section section-forest" id="africa">
  <div class="wrap reveal">
    ...
    <p class="slead" style="color:rgba(255,255,255,.68)">Sub Saharan Africa holds some of the largest reserves of uncultivated arable land anywhere in the world, and Kenya sits inside a continental agenda that already names agricultural transformation and the wellbeing of children and youth as core promises. AgriKonnekt was built to help deliver directly on that promise, functioning as part of the agenda itself rather than a separate product alongside it.</p>
    ...
    <h3 style="font-size:22px;margin-bottom:34px;color:#fff">Roadmap for the first year</h3>
    <div class="roadmap">
...
<div class="flow-divider" style="background:var(--void)">
  <svg viewBox="0 0 1240 64" preserveAspectRatio="none" aria-hidden="true"><path d="M0 32 C 260 60, 400 6, 620 30 S 960 60, 1240 32" fill="none" stroke="var(--lime)" stroke-width="1.2" stroke-dasharray="1 5" opacity=".5"/></svg>
</div>
...
<section class="section" id="opensource">
  <div class="wrap reveal">
    ...
    <div class="elig-grid">
      ...
      <div class="elig-card">
        <span class="elig-check">✓</span>
        <div><h5>Working Prototype, Already Piloted</h5><p>AgriKonnekt is a live platform, with households, farm records and cooperative pilots already running on it today.</p></div>
      </div>
      <div class="elig-card">
        <span class="elig-check">✓</span>
      ...
      <div>
        <div class="chart-card" style="background:var(--cream-warm)">
          ...
          <div style="display:flex;flex-direction:column;gap:16px">
            <div><b style="color:var(--forest);font-family:'EB Garamond',serif;font-size:17px">✓ Live and working</b><p style="font-size:13px;color:var(--mid);margin-top:4px">AgriKonnekt is a working platform already in active use today.</p></div>
            <div><b style="color:var(--forest);font-family:'EB Garamond',serif;font-size:17px">✓ Open by default</b><p style="font-size:13px;color:var(--mid);margin-top:4px">Every layer, code, hardware designs and content, is OSI principles designed or released under a CC BY licence.</p></div>
            <div><b style="color:var(--forest);font-family:'EB Garamond',serif;font-size:17px">✓ Transparent, verifiable data</b><p style="font-size:13px;color:var(--mid);margin-top:4px">Impact data is publicly exposed in real time and stands up to independent verification.</p></div>
            <div><b style="color:var(--forest);font-family:'EB Garamond',serif;font-size:17px">✓ Built for reuse</b><p style="font-size:13px;color:var(--mid);margin-top:4px">Anyone, anywhere, can inspect, adapt, and build freely on the platform.</p></div>
          </div>
        </div>
      </div>
    </div>
...
<section class="section section-void">
  <div class="wrap reveal">
    ...
    <p style="font-family:'EB Garamond',serif;font-style:italic;color:rgba(255,255,255,.4);max-width:720px;margin-top:24px;font-size:13px">This is the standard open core structure: the components a public funder should be able to trust regardless of Kilimora's commercial fortunes are licensed openly and forever, while the infrastructure a paying enterprise customer needs stays commercial, fully separate from anyone's ability to inspect, self host, or build on the open layer.</p>
  </div>
</section>
  ...
  <div class="wrap reveal">
    ...
    <div class="defines-grid">
      <div class="defines-item">
        <svg class="defines-icon" viewBox="0 0 44 44" fill="none"><path d="M6 34h32M13 34V19M22 34V10M31 34V23" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
        <h5>Explainable</h5>
        <p>Every score returns the factors behind it, in plain language, so every number arrives with a clear reason attached.</p>
      </div>
      <div class="defines-item">
        <svg class="defines-icon" viewBox="0 0 44 44" fill="none"><circle cx="22" cy="15" r="6" stroke="var(--lime)" stroke-width="1.6"/><path d="M8 36c0-8 6-13 14-13s14 5 14 13" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round"/></svg>
      ...
      <div class="defines-item">
        <svg class="defines-icon" viewBox="0 0 44 44" fill="none"><path d="M22 6l14 5v9c0 9-6 15-14 18-8-3-14-9-14-18v-9l14-5z" stroke="var(--lime)" stroke-width="1.6" stroke-linejoin="round"/><path d="M16 22l4 4 8-8" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
...
<section class="section" id="how" style="padding-top:0">
  <div class="wrap reveal">
    ...
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px;margin:0 auto 8px;text-align:center">From a phone in someone's pocket to a decision a lender can stand behind</h2>
...
<section class="section" style="padding-top:0">
  <div class="wrap reveal">
    ...
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px;margin-bottom:40px">Everything a lender needs to underwrite a household the formal system has overlooked</h2>
    <div class="feat-grid">
      <div class="feat-card">
...
<section class="section" style="padding-top:0">
  <div class="wrap reveal">
    ...
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px;margin:0 auto 40px;text-align:center">Your data moves only where you can see it going</h2>
    <div class="sd-dom-grid">
      <div class="sd-dom-card">
        <svg class="sd-dom-icon" viewBox="0 0 44 44" fill="none"><rect x="10" y="19" width="24" height="17" rx="3" stroke="var(--lime)" stroke-width="1.6"/><path d="M15 19v-5a7 7 0 0114 0v5" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round"/></svg>
      ...
      <div class="sd-dom-card">
        <svg class="sd-dom-icon" viewBox="0 0 44 44" fill="none"><path d="M22 6l14 5v9c0 9-6 15-14 18-8-3-14-9-14-18v-9l14-5z" stroke="var(--lime)" stroke-width="1.6" stroke-linejoin="round"/><path d="M16 22l4 4 8-8" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
      ...
      <div class="sd-dom-card">
        <svg class="sd-dom-icon" viewBox="0 0 44 44" fill="none"><circle cx="22" cy="22" r="15" stroke="var(--lime)" stroke-width="1.6"/><path d="M14 22h16M22 14v16" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round"/><path d="M14 30l16-16" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round"/></svg>
      ...
      <div class="sd-dom-card">
        <svg class="sd-dom-icon" viewBox="0 0 44 44" fill="none"><path d="M10 22a12 12 0 1024 0 12 12 0 00-24 0z" stroke="var(--lime)" stroke-width="1.6"/><path d="M22 16v6l5 3" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
...
<section class="section" id="demo" style="padding-top:0">
  <div class="wrap reveal">
    ...
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px">Move the sliders, watch the score respond</h2>
    <p style="font-family:'EB Garamond',serif;font-style:italic;color:rgba(255,255,255,.55);max-width:600px;margin-top:10px">A simplified, illustrative version of the scoring engine. The live API scores directly from verified data, this just lets you feel how all eight factors add up.</p>
    ...
    <div class="demo-banner">
      ...
      <div>
        ...
        <p>The sliders below and the tier thresholds they produce (Emerging / Established / Compounding) are simplified, illustrative logic built to show how the scoring concept works. They have not been calibrated against real repayment or savings outcomes. The production credit model is trained and validated separately, on verified household data, before any lending or insurance decision is attached to it.</p>
      </div>
    </div>
...
<section class="section" style="padding-top:0">
  <div class="wrap reveal">
    ...
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px;margin:0 auto 40px;text-align:center">Good for the household, good for the lender behind it</h2>
...
<section class="section" style="padding-top:0">
  <div class="wrap reveal">
    ...
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px;margin:0 auto 8px;text-align:center">No single data point decides a household's future</h2>
...
<section class="section" id="docs" style="padding-top:0">
  <div class="wrap reveal">
    ...
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px;margin-bottom:30px">One call in, a full breakdown out</h2>
    <div class="doc-panel">
...
<section class="papi-hero">
  ...
  <div class="wrap">
    ...
    <h1 style="font-size:clamp(28px,4vw,46px);max-width:820px;margin-bottom:14px">One platform, mapped onto the five things every child focused funder already shows up for</h1>
    <p class="slead" style="max-width:700px">AgriKonnekt is built around five priorities, health, nutrition, education, clean water and emergency response, the same five that anchor almost every serious child wellbeing mandate, from multilateral funds to catalytic philanthropy. Access alone was never the finish line; every mechanism on this page is held to the same standard the sector itself is now applying to development claims more broadly, outcomes a funder can verify independently, not enrollment numbers taken on trust. This page maps that fit, mechanism by mechanism.</p>
...
<section class="section">
  <div class="wrap reveal">
    ...
    <h2 style="font-family:'EB Garamond',serif;font-size:clamp(22px,3vw,28px);max-width:760px;margin-bottom:14px">Built around the same five things every family already worries about</h2>
...
<section class="section" style="padding-top:0">
  <div class="wrap reveal">
    ...
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px;margin:0 auto 8px;text-align:center">Three ways in, whatever your mandate allows</h2>
...
<section class="section" style="background:var(--void-2);padding-top:80px;padding-bottom:80px">
  <div class="wrap reveal">
    ...
    <h2 style="font-family:'EB Garamond',serif;font-size:clamp(22px,3vw,28px);color:#fff;margin-bottom:10px;max-width:700px">Built to satisfy the process, not retrofitted to survive it</h2>
...
<section class="section" style="background:var(--void-2);padding-top:80px;padding-bottom:80px">
  <div class="wrap reveal">
    ...
    <h2 style="font-family:'EB Garamond',serif;font-size:clamp(22px,3vw,28px);color:#fff;margin-bottom:10px;max-width:700px">Written for the whole sector, not one funder in it</h2>
    <p style="font-family:'EB Garamond',serif;font-style:italic;color:rgba(255,255,255,.55);max-width:660px;font-size:14px">No single mechanism finances a child's whole path out of vulnerability. The categories below are illustrative of the kind of partner this platform is built to satisfy, drawn from across the sector rather than naming any one funder as the intended audience.</p>
    ...
    <h3 style="font-family:'EB Garamond',serif;font-size:20px;color:#fff;max-width:640px">The actual levers a partner can pull today, on a child's behalf</h3>
...
<section class="section" style="background:var(--void-2);padding-top:80px;padding-bottom:90px;text-align:center">
  <div class="wrap reveal">
    ...
    <h2 style="font-family:'EB Garamond',serif;font-size:clamp(22px,3vw,30px);color:#fff;max-width:720px;margin:0 auto 14px">Built to align with exactly the kind of call any serious child development funder puts out every year</h2>
    <p style="font-family:'EB Garamond',serif;font-style:italic;color:rgba(255,255,255,.55);max-width:660px;margin:0 auto;font-size:14px">Health, nutrition, education, water, and protection from the next shock, the same five pillars this initiative is built around, and the same priorities a programme officer somewhere is currently reviewing applications against. Somewhere, a child is waiting to find out which way that decision goes.</p>
...
<section class="papi-hero">
  ...
  <div class="wrap">
    ...
    <h1 style="font-size:clamp(28px,4vw,46px);max-width:820px;margin-bottom:14px">Somewhere right now, a child is deciding whether an empty afternoon becomes a football pitch, or a doorway to trouble</h1>
    <p class="slead" style="max-width:700px">Somewhere in Nairobi right now, a child is deciding whether an empty afternoon becomes a football pitch, or a doorway to trouble, and for most, there is no pitch waiting at all. That gap, not talent or effort, is what this initiative closes. And it is bigger than sport: any structured, mentored, after school activity, a court, a music room, a robotics table, works the same way. Sport simply anchors it, as the best evidenced, most scalable place to start, backed by the studies below rather than assumed to work because a similar programme worked somewhere else.</p>
...
<section class="section">
  <div class="wrap reveal">
    ...
    <h2 style="font-family:'EB Garamond',serif;font-size:clamp(22px,3vw,28px);color:#fff;margin-bottom:10px;max-width:680px">Sport is not a side activity to a child's development. In the research, it is a delivery mechanism for most of it.</h2>
...
<section class="section" style="background:var(--void-2);padding-top:80px;padding-bottom:80px">
  <div class="wrap reveal">
    ...
    <h2 style="font-family:'EB Garamond',serif;font-size:22px;color:#fff;text-align:center;max-width:640px;margin:0 auto 8px">One activity, four development domains, at the same time</h2>
    <div class="sd-dom-grid">
      <div class="sd-dom-card">
        <svg class="sd-dom-icon" viewBox="0 0 44 44" fill="none"><path d="M22 6v32M8 22h28" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round"/><circle cx="22" cy="22" r="15" stroke="var(--lime)" stroke-width="1.6"/></svg>
        <h5>Physical</h5>
      ...
      <div class="sd-dom-card">
        <svg class="sd-dom-icon" viewBox="0 0 44 44" fill="none"><circle cx="22" cy="15" r="6" stroke="var(--lime)" stroke-width="1.6"/><path d="M8 36c0-8 6-13 14-13s14 5 14 13" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round"/></svg>
        <h5>Psychological</h5>
        <p>Self perception, reduced depressive symptoms, and a durable sense of belonging built through team structure.</p>
        <span class="sdg-chip"><span class="sdg-num" style="background:#4C9F38">3</span>Health</span>
      </div>
      <div class="sd-dom-card">
        <svg class="sd-dom-icon" viewBox="0 0 44 44" fill="none"><path d="M6 34h32M13 34V19M22 34V10M31 34V23" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
...
<section class="section">
  <div class="wrap reveal">
    ...
    <h2 style="font-family:'EB Garamond',serif;font-size:clamp(22px,3vw,28px);color:#fff;margin-bottom:10px;max-width:700px">Why we call it Sport &amp; Community Development, and mean the second half of that name just as much</h2>
    <p style="font-family:'EB Garamond',serif;font-style:italic;color:rgba(255,255,255,.55);max-width:680px;font-size:14px;margin-bottom:24px">A basketball court in Jericho and a music room in Komarock are solving the same problem: a child with structured hours, a caring adult, and somewhere to belong. We build for both, and everything in between.</p>
    <div class="sd-dom-grid">
      <div class="sd-dom-card">
        <svg class="sd-dom-icon" viewBox="0 0 44 44" fill="none"><circle cx="22" cy="22" r="16" stroke="var(--lime)" stroke-width="1.6"/><path d="M14 26c2-8 6-12 8-12s6 4 8 12" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round"/></svg>
      ...
      <div class="sd-dom-card">
        <svg class="sd-dom-icon" viewBox="0 0 44 44" fill="none"><path d="M10 30V14l12-6 12 6v16" stroke="var(--lime)" stroke-width="1.6" stroke-linejoin="round"/><path d="M10 30h24M17 30v-8h10v8" stroke="var(--lime)" stroke-width="1.6" stroke-linejoin="round"/></svg>
      ...
      <div class="sd-dom-card">
        <svg class="sd-dom-icon" viewBox="0 0 44 44" fill="none"><path d="M8 34l8-16 6 10 6-14 8 20" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
      ...
      <div class="sd-dom-card">
        <svg class="sd-dom-icon" viewBox="0 0 44 44" fill="none"><circle cx="15" cy="16" r="5" stroke="var(--lime)" stroke-width="1.6"/><circle cx="29" cy="16" r="5" stroke="var(--lime)" stroke-width="1.6"/><path d="M6 36c0-7 4-11 9-11s9 4 9 11M20 36c0-7 4-11 9-11s9 4 9 11" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round"/></svg>
...
<section class="section" style="background:var(--void-2);padding-top:80px;padding-bottom:80px">
  <div class="wrap reveal">
    ...
    <h2 style="font-family:'EB Garamond',serif;font-size:clamp(22px,3vw,28px);color:#fff;margin-bottom:10px;max-width:680px">The organisations already doing this, and where each one sits in the system</h2>
    <p style="font-family:'EB Garamond',serif;font-style:italic;color:rgba(255,255,255,.55);max-width:640px;font-size:14px">No single organisation covers a child's whole journey through sport. Real systemic change means these pieces working as one system instead of six separate ones that each only see a fraction of the child in front of them.</p>
    <div class="sd-eco-grid">
      <div class="sd-eco-card">
    ...
    <div class="eyebrow" style="margin-top:56px">Mechanisms Available</div>
    <h3 style="font-family:'EB Garamond',serif;font-size:20px;color:#fff;max-width:640px">The actual levers an organisation can pull today, on that child's behalf</h3>
    <div class="sd-mech-strip">
...
<section class="section">
  <div class="wrap reveal">
    ...
    <h2 style="font-family:'EB Garamond',serif;font-size:clamp(22px,3vw,28px);color:#fff;margin-bottom:10px;max-width:680px">Football carries a career pathway most other sports do not, and that cuts both ways</h2>
    <p style="font-family:'EB Garamond',serif;font-style:italic;color:rgba(255,255,255,.55);max-width:640px;font-size:14px">Millions of unregistered youth players across Africa may have real ability. Whether that turns into a scholarship or a scam depends entirely on the quality of the system around them, and right now, too often, there is no system at all.</p>
...
<section class="section" style="background:var(--void-2);padding-top:80px;padding-bottom:80px">
  <div class="wrap reveal">
    ...
    <h2 style="font-family:'EB Garamond',serif;font-size:clamp(22px,3vw,28px);color:#fff;margin-bottom:16px;max-width:680px">What is already been done, and where it still falls short</h2>
...
<section class="section">
  <div class="wrap reveal">
    ...
    <h2 style="font-family:'EB Garamond',serif;font-size:22px;color:#fff;margin-bottom:6px;max-width:640px">Faces from the communities every page above was written for</h2>
    ...
    <div style="text-align:center;margin-top:64px">
      <div class="eyebrow" style="justify-content:center">Where This Fits</div>
      <h3 style="font-family:'EB Garamond',serif;font-size:24px;color:#fff;max-width:680px;margin:0 auto 14px">Built to align with exactly the kind of call the UEFA Foundation for Children puts out every year</h3>
      <p style="font-family:'EB Garamond',serif;font-style:italic;color:rgba(255,255,255,.55);max-width:640px;margin:0 auto;font-size:14px">Health, education, access to sport, personal development, integration, and protection of children's rights, the same six pillars this initiative is built around, and the same six a Board of Trustees somewhere is currently reviewing applications against. Somewhere, a child is waiting to find out which way that decision goes.</p>
...
<section class="papi-hero">
  ...
  <div class="wrap">
    ...
    <p class="slead">About a billion children already live in countries facing high climate and environmental risk, and roughly one in five now live through at least twice as many extreme heat days as in the 1960s. Most of the technology built to respond to that sits far from the household actually carrying the risk. AgriKonnekt already holds a verified, traceable record for every household it serves. This pathway turns that same record into a hazard map, an early warning, a health forecast, and a point of care assistant, so the household hears about the shock before it lands, not after.</p>
...
<section class="section">
  <div class="wrap reveal">
    ...
    <h2 class="stitle" style="font-size:clamp(22px,3vw,28px);max-width:700px">Children carry the heaviest cost of a changing climate, with the least say in the response</h2>
    <div class="sd-ev-grid">
      <div class="sd-ev-card">
...
<section class="section" style="background:var(--void-2);padding-top:80px;padding-bottom:80px">
  <div class="wrap reveal">
    <div class="eyebrow" style="justify-content:center">Where It Lands</div>
    <h2 style="font-family:'EB Garamond',serif;font-size:22px;color:#fff;text-align:center;max-width:640px;margin:0 auto 8px">One household record, four modules, turned on as needed</h2>
    <div class="sd-dom-grid">
      <div class="sd-dom-card">
...
<section class="section">
  <div class="wrap reveal">
    ...
    <h2 style="font-family:'EB Garamond',serif;font-size:clamp(22px,3vw,28px);color:#fff;margin-bottom:10px;max-width:700px">No new registration, no new device, no new agency required to start</h2>
    <p style="font-family:'EB Garamond',serif;font-style:italic;color:rgba(255,255,255,.55);max-width:680px;font-size:14px;margin-bottom:24px">This is not a separate platform bolted on next to AgriKonnekt. It reads from the same verified household layer that already powers financial enablement and traceability, and it is built open source, so any ministry, hospital, school system, or community partner can run it under its own control.</p>
...
<section class="section">
  <div class="wrap reveal">
    <div style="text-align:center">
      <div class="eyebrow" style="justify-content:center">Where This Fits</div>
      <h3 style="font-family:'EB Garamond',serif;font-size:24px;color:#fff;max-width:680px;margin:0 auto 14px">Built for the kind of call any climate or child health funder already runs</h3>
      <p style="font-family:'EB Garamond',serif;font-style:italic;color:rgba(255,255,255,.55);max-width:640px;margin:0 auto;font-size:14px">Open source licensing, a functional prototype, and a for profit or non profit team building at the intersection of climate resilience and child health, the same shape almost every frontier climate funding call already asks for. This pathway is built to stand on its own evidence, under any institution's name, not only AgriKonnekt's.</p>
...
<section class="papi-hero" style="background:radial-gradient(ellipse at 30% 20%,rgba(193,78,99,.10),transparent 55%),linear-gradient(160deg,#141310,#0A0C09)">
  <div class="wrap">
...
<section class="section">
  <div class="wrap reveal">
    ...
    <div class="defines-grid">
      <div class="defines-item">
        <svg class="defines-icon" viewBox="0 0 44 44" fill="none"><circle cx="14" cy="30" r="6" stroke="var(--lime)" stroke-width="1.6"/><circle cx="30" cy="30" r="6" stroke="var(--lime)" stroke-width="1.6"/><circle cx="22" cy="14" r="6" stroke="var(--lime)" stroke-width="1.6"/></svg>
...
<section class="section" id="how" style="padding-top:0">
  <div class="wrap reveal">
    <div class="eyebrow" style="justify-content:center">How It Works</div>
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px;margin:0 auto 8px;text-align:center">Three modules, one number a partner can act on the same day</h2>
...
<section class="section" style="padding-top:0">
  <div class="wrap reveal">
    <div class="eyebrow" style="justify-content:center">In This System We Trust</div>
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px;margin:0 auto 40px;text-align:center">A score about a child carries a higher bar, not a lower one</h2>
    <div class="sd-dom-grid">
      <div class="sd-dom-card">
        <svg class="sd-dom-icon" viewBox="0 0 44 44" fill="none"><path d="M22 6l14 5v9c0 9-6 15-14 18-8-3-14-9-14-18v-9l14-5z" stroke="var(--lime)" stroke-width="1.6" stroke-linejoin="round"/><path d="M16 22l4 4 8-8" stroke="var(--lime)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
...
<section class="section" id="explorer" style="padding-top:0">
  <div class="wrap reveal">
    <div class="eyebrow">Try It</div>
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px">Move the sliders, watch all three modules respond</h2>
    <p style="font-family:'EB Garamond',serif;font-style:italic;color:rgba(255,255,255,.55);max-width:620px;margin-top:10px">A simplified, illustrative version of the scoring engine. The climate module's first slider starts from the live weather feed above, real numbers, edit it and it stops following the feed.</p>
    ...
    <div class="demo-panel" style="margin-top:20px;text-align:center">
      ...
      <p class="demo-disclaimer" style="margin-top:14px">Illustrative only. The production model scores against verified household data and the live weather feed directly; this panel lets you feel how the three modules combine.</p>
    </div>
  </div>
</section>
...
<section class="section" style="padding-top:0">
  <div class="wrap reveal">
    <div class="eyebrow" style="justify-content:center">Voices From The Field</div>
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px;margin:0 auto 40px;text-align:center">A number that tells a partner where to look first</h2>
    <div class="voice-grid">
      <div class="voice-card">
...
<section class="section" style="padding-top:0">
  <div class="wrap reveal">
    ...
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px;margin:0 auto 8px;text-align:center">Started with three modules, on purpose</h2>
...
<section class="section" id="docs" style="padding-top:0">
  <div class="wrap reveal">
    <div class="eyebrow">Documentation</div>
    <h2 style="font-size:clamp(24px,3vw,34px);max-width:640px;margin-bottom:30px">One call in, three sub scores and a composite out</h2>
    <div class="doc-panel">
      <div class="code-block">
        <div class="cb-label">Request</div>
...
<section class="section">
  <div class="wrap reveal">
    <div style="text-align:center">
      <div class="eyebrow" style="justify-content:center">Where This Fits</div>
      <h3 style="font-family:'EB Garamond',serif;font-size:24px;color:#fff;max-width:680px;margin:0 auto 14px">Built for the kind of evidence a child innovation fund already asks for</h3>
      <p style="font-family:'EB Garamond',serif;font-style:italic;color:rgba(255,255,255,.55);max-width:640px;margin:0 auto;font-size:14px">A working prototype, open licensing, and publicly exposed, measurable real time data, built at the exact intersection of food security, education continuity and climate resilience that a fund reviewing this space is already scoring applications against.</p>
...
<footer>
  <div class="wrap reveal" id="contact" style="padding-bottom:32px;margin-bottom:32px;border-bottom:1px solid rgba(255,255,255,.14);text-align:center;display:flex;align-items:center;justify-content:center;gap:24px;flex-wrap:wrap">
    <p style="margin:0;font-family:'EB Garamond',serif;font-style:italic;font-size:18px;color:#fff">Want to see what this can do for one more child's household? Get in touch with the team.</p>
...
(function(){
  ...
  if (flowPanels.length){
    ...
    function flowUpdate(){
      ...
      cue.classList.toggle('hide', window.scrollY > 140);
    }
    window.addEventListener('scroll', function(){
