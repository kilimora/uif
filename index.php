...
.hero h1{font-size:clamp(26px,5.4vh,70px);color:#fff;max-width:1040px;margin-bottom:clamp(8px,1.4vh,20px);font-weight:600;letter-spacing:-.02em;line-height:1.08;flex-shrink:0}
...
.hstat b{display:block;font-family:'JetBrains Mono',monospace;font-size:clamp(16px,2.4vh,27px);color:var(--lime-soft);font-weight:700;line-height:1}
...
.fw-item{font-family:'EB Garamond',serif;font-style:italic;font-size:22px;color:var(--mid);display:inline-flex;align-items:center;gap:20px}
...
.sol-card{background:rgba(201,240,77,.04);border-left:3px solid var(--lime);border-radius:0 var(--r-card) var(--r-card) 0;padding:32px 24px}
...
.sd-mech-strip{display:flex;flex-wrap:wrap;gap:10px;margin-top:26px}
.sd-mech-pill{font-family:'JetBrains Mono',monospace;font-size:13px;letter-spacing:.05em;text-transform:uppercase;padding:9px 17px;border:1px solid rgba(255,255,255,.15);border-radius:999px;color:rgba(255,255,255,.62);white-space:nowrap}
.pull{position:relative;background:var(--void-2,#12150E);border-left:3px solid var(--lime);border-radius:0 14px 14px 0;padding:30px 30px 26px;margin:28px 0;font-family:'EB Garamond',serif;font-style:italic;font-size:25px;color:rgba(255,255,255,.82)}
...
.goal-band{text-align:center;padding:56px 40px;background:rgba(95,180,224,.08);border-top:2px solid var(--childblue);border-radius:var(--r-card)}
...
.flow-scroll-cue{position:fixed;left:50%;bottom:30px;transform:translateX(-50%);z-index:70;font-family:'JetBrains Mono',monospace;font-size:13px;letter-spacing:.18em;text-transform:uppercase;color:rgba(255,255,255,.8);display:flex;flex-direction:column;align-items:center;gap:10px;pointer-events:none;transition:opacity .5s ease;mix-blend-mode:difference}
